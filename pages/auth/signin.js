                ...
                <Row className="m-0 align-items-center bg-white vh-100">
                    <Col md="6">
                        <Row className="justify-content-center">
                            <Col md="10">
                                <Card
                                    className="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                                    <Card.Body>
                                        <div className="navbar-brand d-flex align-items-center mb-3">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                 width="120" viewBox="0 0 150 55.56">
                                                <linearGradient id="linear-gradient" x1="3.28" y1="26.49" x2="19.74"
                                                                y2="-2.03" gradientUnits="userSpaceOnUse">
                                                    ...
                                                    <Col lg="12" className="d-flex justify-content-between">
                                                        <Form.Check className="form-check mb-3">
                                                            <Form.Check.Input type="checkbox"
                                                                              ...
                                                                              name="remember_me"
                                                                              id="customCheck1"/>
                                                            <Form.Check.Label htmlFor="customCheck1">Remember
                                                                Me</Form.Check.Label>
                                                        </Form.Check>
                                                    </Col>
                                                </Row>
                    ...
                    <Col md="6"
                        ...
                        <Image src="/assets/images/signinbg.png" layout="fill" sizes="100%" quality={100}
                               objectFit="cover" alt="sign in background"/>
                    </Col>
                </Row>
            </section>
            <ToastContainer
