                            ...
                            <Card className="shadow-none">
                                <Card.Body>
                                    ...
                                    <div className="mt-5 d-flex justify-content-end">
                                        ...
                                        <button className="btn btn-primary px-3 py-2 ms-3">{t("Save_changes")}</button>
                                            ...
                                            <Card.Body>
                                                ...
                                                <div>
                                                    {featuesList1.map(item => {
                                                        return (<div key={item} className="p-2">- {t(item)}</div>)
                                                    })}
                                                </div>
                                            </Card.Body>
                                        </Card>

                                        {["History", "Alerts_and_notifications", "Operate_Vehicle", "Manage_Devices"].map((ele, i) => {
                                            return (
