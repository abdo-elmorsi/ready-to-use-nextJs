                ...
                <Card className="shadow-none">
                    <Card.Body>
                        ...
                        <h4 className="card-title mb-5 mt-3">Add New Device</h4>
                            ...
                            <Row className=" rounded p-3 mb-3">
                              <h4 className="card-title mb-5 mt-3">Edit SIMCard Information</h4>
                              <Col lg="12">
                                <div className="mb-3">
                                  <Form.Group className="form-group">
                                    <Form.Label  htmlFor="ManufactCompanyName">Select SIMCard</Form.Label>
                                        <Select options={model} />
                                    </Form.Group>
                                </div>
                              </Col>
                              ...
                              <Col lg="12">
                                <div className="mb-3">
                                  <Form.Group className="form-group">
                                    <Form.Label  htmlFor="ManufactCompanyName">SIM Provider</Form.Label>
                                        <Select options={model} />
                                    </Form.Group>
                                </div>
                              </Col>
