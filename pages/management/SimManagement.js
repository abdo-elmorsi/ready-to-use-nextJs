  ...
  return (
      <div>
          <button className="btn btn-outline-primary m-1">
              <FontAwesomeIcon className="pe-2" icon={faEdit} size="lg"/>Assin to Device</button>
          <button className="btn btn-outline-primary m-1">
              <FontAwesomeIcon className="pe-2" icon={faPen} size="lg"/>Edit </button>
          <button className="btn btn-outline-primary m-1">
        ...
        <h4>Manage SIMCards</h4>
          <Card.Header className="d-flex justify-content-between">
            <div
                ...
                <div>
                    {["Add SIMCard","Add SIMCard Bulk", "Export Assigned SIMCards"].map(el =>{
                      return(
                        <>
          ...
          <div className="table-responsive">
            <table id="datatable" className="table table-striped text-center table-hover"
                ...
                <thead>
                <tr>
                    {["SIMCard Serial Number", "Phone Number", "Provider Name", "Device Serial Number", "Actions"].map((el) => {
                        return (
                            <th key={el}>{el}</th>
                        )
                    })}
          ...
          <Card.Header className="d-flex justify-content-between">
            <div
                className="w-100 header-title d-flex justify-content-between align-items-center p-3">
                <div>
                  <button type="button" className="btn btn-primary  px-3 py-2 me-3">Export Unassigned SIMCards</button>
                </div>
                <Form.Floating className=" custom-form-floating-sm form-group m-0">
                    <Form.Control type="email" className="" id="floatingInput6"
                                  placeholder="Place Holder"/>
          ...
          <div className="table-responsive">
            <table id="datatable" className="table table-striped text-center table-hover"
                ...
                <thead>
                <tr>
                    {["SIMCard Serial Number", "Phone Number", "Provider Name", "Actions"].map((el) => {
                        return (
                            <th key={el}>{el}</th>
                        )
                    })}
