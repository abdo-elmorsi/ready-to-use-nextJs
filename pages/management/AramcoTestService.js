...
const AramcoTestService = () => {
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Col lg="12">
                      <div className="mb-3">
                        <Form.Group className="form-group">
                          <Form.Label  htmlFor="ProviderName">List Of Commands</Form.Label>
              ...
              <Modal.Footer>
                <div className="mt-5 d-flex justify-content-end">
                  <button className="btn btn-primary px-3 py-2 ms-3" type="submit">Submit</button>
                  <button className="btn btn-primary px-3 py-2 ms-3" onClick={props.onHide}>Cancel</button>
                </div>
        </Modal.Footer>
      </Modal>
    );
  ...
  function SubmitDeviceBtn() {
    ...
    return (
      <>
        <Button type="Button" className="btn btn-primary  px-3 py-2 me-3 " onClick={() => setModalShow(true)}>Submit Device </Button>
