              ...
              <Col md="8">
                <Card className="shadow-none">
                    <Card.Body>
                        ...
                        <h4 className="card-title mb-5 mt-3">Edit Vehicle Information</h4>
                              
                              <Col lg="6">
                              <Form.Group className="form-group">
                                <Form.Label  htmlFor="displayName">Display Name </Form.Label>
                                <Form.Control type="text"  id="displayName" defaultValue="Maaz Khan 5716 ULB"/>
                              </Form.Group>
                              </Col>
                              <Col lg="6">
                              <Form.Group className="form-group">
                              ...
                              <Form.Group className="form-group">
                                ...
                                <Form.Control type="number"  id="ManufactureYear" defaultValue="2020"/>
                              </Form.Group>
                              </Col>
                              ...
                              <Form.Group className="form-group">
                                ...
                                <Form.Control type="number"  id="speedLimit" defaultValue="120"/>
                              </Form.Group>
                              </Col>
                              <Col lg="6">
                              <Form.Group className="form-group">
                                <Form.Label  htmlFor="LiterPer100KM">Liter Per 100KM</Form.Label>
                                <Form.Control type="number"  id="LiterPer100KM" defaultValue="0"/>
                              </Form.Group>
                              </Col>
                              <Col lg="6">
                              <Form.Group className="form-group">
                                <Form.Label  htmlFor="maxParkingTime">Maximum Parking time</Form.Label>
                                <Form.Control type="number"  id="maxParkingTime" defaultValue="0"/>
                              </Form.Group>
                              </Col>
                              <Col lg="6">
                              <Form.Group className="form-group">
                                <Form.Label  htmlFor="maxIdllingTime">Maximum Idlling time</Form.Label>
                                <Form.Control type="number"  id="maxIdllingTime" defaultValue="0"/>
                              </Form.Group>
                              </Col>
                              ...
                              <Col lg="6" className="d-flex justify-content-between">
                                ...
                                <Form.Check className="form-check mb-3">
                                  <Form.Check.Input type="checkbox"  id="JedahIntegrated" className="radius-2"/>
                                  <Form.Check.Label htmlFor="JedahIntegrated">JedahIntegrated</Form.Check.Label>
                                </Form.Check>
                              </Col>
                            </Row>

                            <Row className=" rounded p-3 mb-3">
                              <h4 className="card-title mb-5 mt-3">Edit Groups Information</h4>
                              <Col lg="6">
                                <div className="mb-3">
                                  <Form.Group className="form-group">
                                    <Form.Label  htmlFor="ManufactCompanyName">Model</Form.Label>
                            ...
                            <Row className=" rounded p-3 mb-3">
                              <h4 className="card-title mb-5 mt-3">Weight Sensor Setup (Optional)</h4>
                              <Col lg="6">
                                <Form.Group className="form-group">
                        ...
                        <div className="mt-5 d-flex justify-content-end">
                          <button className="btn btn-primary px-3 py-2 ms-3">Save WASl and Weight</button>
