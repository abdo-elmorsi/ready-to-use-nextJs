  ...
  const handleChange = (e) => {
    ...
    return (
      <Col>
        ...
        <Col sm="4">
          <Image src={state.file || "https://i.imgur.com/vCihc0e.jpg" } className="rounded img-thumbnail" alt="Profile Picture" width="100" height="100" />
        </Col>  
        </Row>
        </Col>
    );
        ...
        <Row className=" d-flex justify-content-center"> 
          ...
          <h4 className="my-3">Edit Driver Info</h4>
                ...
                <h4 className="my-3">WASL Integration (Optional)</h4>
                  ...
                  <Col lg="6">
                    <Form.Group className="form-group">
                      <Form.Label  htmlFor="IdentityNumber">Identity Number</Form.Label>
                      <Form.Control type="number"  id="IdentityNumber"/>
                    </Form.Group>
                  </Col>
                  <Col lg="6">
                    <Form.Group className="form-group">
                      <Form.Label  htmlFor="DateOfBirthHijri">Date Of Birth Hijri</Form.Label>
