...
export const Actions = ({ id }) => {
  return (
    <div className="d-flex  flex-column text-primary">
      ...
      <Button className=" text-start mb-1">
        <FontAwesomeIcon className="me-2" icon={faUserSlash} size="sm" />
        Deactivate
      </Button>
      <Button className=" text-start mb-1">
      ...
      <Button className=" text-start mb-1">
        <FontAwesomeIcon className="me-2" icon={faEye} size="sm" />
        Show Buttonsers
      </Button>
    </div>
  );
            ...
            <Card.Body>
              <div className="d-flex justify-content-center justify-content-md-between flex-wrap">
                <div className="d-flex justify-content-end mb-4">
                  <Button variant="primary p-2" style={{ fontSize: "13px" }}>
                    <FontAwesomeIcon
                      className="me-2"
                      icon={faCalendarAlt}
                      size="sm"
