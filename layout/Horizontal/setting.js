...
// Selectores
export const getDarkMode = (state) => state.scheme;
export const getcustomizerMode = (state) => state.colorcustomizer;
export const getcustomizerinfoMode = (state) => state.colorinfo;
export const getcustomizerprimaryMode = (state) => state.colorprimary;
export const getDirMode = (state) => state.schemeDir;
export const getSidebarColorMode = (state) => state.sidebarcolor;
export const getSidebarTypeMode = (state) => state.sidebarType;
export const getSidebarActiveMode = (state) => state.sidebarActiveStyle;
export const getNavbarStyleMode = (state) => state.navbarstyle;
