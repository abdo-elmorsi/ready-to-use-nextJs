                            ...
                            <Dropdown as="li" className="nav-item">
                                <Dropdown.Toggle variant="nav-link py-0 d-flex align-items-center" id="navbarDropdown"
                                    ...
                                    <Image src={"/assets/images/avatars/01.png"} width={40} height={40}
                                           alt="User-Profile" className="img-fluid avatar avatar-rounded avatar-rounded"/>
                                ...
                                <Dropdown.Menu className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item as={Link} href="/Setting" className="p-2" ><a className="d-block px-3">{t("Setting")}</a></Dropdown.Item>
                                    <Dropdown.Divider/>
                                    <Dropdown.Item as={Link} href="/" className="p-2" ><a className="d-block px-3">{t("Logout")}</a></Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Nav>
                    </Navbar.Collapse>
