            ...
            <Navbar expand="lg" variant="light" className="nav iq-navbar">
                <Container fluid className="navbar-inner">
                    <div className="navbar-brand mx-5">
                        <Image src="/assets/images/saferoad_logo_dark.svg" width="150" height="80px" alt="" />
                        ...
                        <Nav as="ul" className="ms-auto navbar-list mb-2 mb-lg-0 d-flex align-items-stretch">
                            ...
                            <Dropdown as="li" className="nav-item">
                                ...
                                <Dropdown.Menu className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item as={Link} href="/Setting" className="p-2" >{t("Setting")}</Dropdown.Item>
                                    <Dropdown.Divider/>
                                    <Dropdown.Item as={Link} href="/" className="p-2" >{t("Logout")}</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Nav>
                    </Navbar.Collapse>
