            ...
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
                    <Link href="/preventiveMaintenance">
                        ...
                        <div className={`${router.pathname === '/preventiveMaintenance' ? 'active' : ''} nav-link `}>
                            <i className="icon">
                    ...
                    <Link href="/DriversManagement">
                        <a>
                            <OverlayTrigger
                                ...
                                <div className={`${router.pathname === '/DriversManagement' ? 'active' : ''} nav-link `}>
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.8496 4.25024V6.67024" stroke="currentColor" strokeWidth="1.5"
                                                strokeLinecap="round"
                        ...
                        <a>
                            <OverlayTrigger
                                ...
                                <div className={`${router.pathname === '/Management' ? 'active' : ''} nav-link `}>
                                    ...
                                    <span className="item-name">Management</span>
                                </div>
                            </OverlayTrigger>
                        </a>
                    </Link>
